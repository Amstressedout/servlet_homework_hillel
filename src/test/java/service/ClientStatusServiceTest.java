...
public class ClientStatusServiceTest {
    ...
    private void clientStatusInitialization() {
        ...
        when(clientStatusDao.findAllFromClientStatus()).thenReturn(Collections.singletonList(clientStatus));
    }

    @Test
    public void findClientNameEmailStatusMethodCheckBySizeCorrectValuesTest() {
        List<ClientStatusDto> actualList = clientStatusService.findAllFromClientStatus();
